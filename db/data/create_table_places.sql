...
--
drop table if exists ref_place_details;
create table ref_place_details (
  ...
  latitude float(20),
  primary key (code),
  key `geographical codes` (city_code, continent_code, country_code,
   	  					    region_code, time_zone_grp)
...
-- Depends on language
--
drop table if exists ref_place_names;
create table ref_place_names (
