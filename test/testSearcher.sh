...
TST_PROG=../opentrep/batches/opentrep_searcher
...
then
	echo "Usage: $0 [<search string> [<log file name> [<Xapian database name (directory of the index)>]]"
	echo "That program searches through the Xapian database (index) for travel-related data."
	echo
