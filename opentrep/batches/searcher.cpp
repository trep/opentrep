...
const std::string K_OPENTREP_DEFAULT_LOG_FILENAME ("opentrep_searcher.log");
...
int readConfiguration (int argc, char* argv[], 
  ...
  config.add_options()
    ...
    ("user,u",
     ...
     "SQL database hostname (e.g., opentrep)")
    ("passwd,p",
    ...
    ("dbname,m",
     ...
     "SQL database name (e.g., opentrep)")
    ("type,t",
  ...
  std::ifstream ifs ("opentrep_searcher.cfg");
    ...
    */
    ...
    const int lOptionParserStatus = 
      readConfiguration (argc, argv, lSpellingErrorDistance, lTravelQuery,
                         lXapianDatabaseName, lLogFilename,
