...
namespace OPENTREP {
  ...
  /** Structure wrapping a Xapian document having matched part of a
      given query string.
      <br>It is a structure, as it is aimed to be temporary, the time
  ...
  public:
    ...
    /** Get the corrected query string.
        <br>When empty, it means that no correction was necessary. */
  ...
  private:
    ...
    /** Matching percentage, as returned by the Xapian full text search.
        <br>Generally, that percentage is equal to, or close to, 100%. */
    ...
    /** List of Xapian documents having the same matching percentage.
        <br>Hence, any of those other Xapian documents could have been
    ...
    /** List of Xapian documents having the a lower matching percentage.
        <br>Those alternate matches can be suggested (in the famous
