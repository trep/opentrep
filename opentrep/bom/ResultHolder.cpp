...
namespace OPENTREP {
  ...
  // //////////////////////////////////////////////////////////////////////
  std::string ResultHolder::searchStringNew(const TravelQuery_T& iQueryString,
    ...
    try {
      ...
      for (StringSet::StringSet_T::const_iterator itString =
        ...
        const std::string& lMatchedString =
          searchStringNew (lQueryString, lMatchingDocument);
  ...
  // //////////////////////////////////////////////////////////////////////
  void ResultHolder::searchStringNew (DocumentList_T& ioDocumentList,
                                      WordList_T& ioWordList) {
