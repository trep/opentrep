...
namespace OPENTREP {
  ...
  namespace PorParserHelper {
    ...
    struct storeIataCode : public ParserSemanticAction {
      ...
      void operator() (Context const&) const;
    };
    ...
    /** Store the parsed boolean whether or not it is Geonames. */
    struct storeIsGeonames : public ParserSemanticAction {
      /** Actor Constructor. */
      storeIsGeonames (Location&);
      /** Actor Function (functor). */
      template <typename Context>
      void operator() (Context const&) const;
    };
    ...
    /** Store the temporary parsed year. */
    struct storeDateYear : public ParserSemanticAction {
      /** Actor Constructor. */
      storeDateYear (Location&);
      /** Actor Function (functor). */
      template <typename Context>
      void operator() (Context const&) const;
    };

    /** Store the temporary parsed month. */
    struct storeDateMonth : public ParserSemanticAction {
      /** Actor Constructor. */
      storeDateMonth (Location&);
      /** Actor Function (functor). */
      template <typename Context>
      void operator() (Context const&) const;
    };

    /** Store the temporary parsed day. */
    struct storeDateDay : public ParserSemanticAction {
      /** Actor Constructor. */
      storeDateDay (Location&);
      /** Actor Function (functor). */
      template <typename Context>
      void operator() (Context const&) const;
    };
